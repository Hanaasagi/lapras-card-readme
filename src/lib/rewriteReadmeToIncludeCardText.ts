...
const createCardText = ({
  ...
  const imageUrl = `https://lapras-card-generator.vercel.app/api/svg?e=${score.eScore
  ...
  return `<a align="right" href="https://lapras.com/public/${shareId}" target="_blank" rel="noopener noreferrer"><img src="${imageUrl}" width="${cardWidth}" ></a>${updateTime}`
}
